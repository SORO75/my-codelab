...
public interface Modellverwaltung {
	...
	/**
	 * Liefert alle Persistenten Angebotsmodelle zur&uuml;ck
	 * @return Collection vom Typ Modell
	 */
	 ...
	 * 
	 * @param typ
	 * @param radbezeichnung
	 * @param maxpreis
	 * @return
	 */
	public List<AngebotsModell> searchModell(Fahrradtyp typ, String radbezeichnung, float maxpreis);
}
