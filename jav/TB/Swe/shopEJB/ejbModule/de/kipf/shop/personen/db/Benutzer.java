...
public class Benutzer implements java.io.Serializable, Comparable {
	...
	@ManyToMany(mappedBy = "benutzer", fetch=EAGER)
...
//		regdatum = new Date();
	...
	public int compareTo(Object other) {
		if (!(other instanceof Benutzer)) return -1;
		final Benutzer ob = (Benutzer) other;
		return this.benutzername.compareToIgnoreCase(ob.benutzername);
	}
